...
module.exports = function (db) {
  function create(client, workspaceId, title, definition, callback) {
    logger.debug('creating subproblem');
    const query =
      'INSERT INTO subproblem (workspaceid, title, definition) VALUES ($1, $2, $3) RETURNING id';
    client.query(query, [workspaceId, title, definition], function (
      error,
      result
    ) {
  ...
  function deleteSubproblem(client, subproblemId, callback) {
