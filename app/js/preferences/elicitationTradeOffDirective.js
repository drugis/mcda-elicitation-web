'use strict';
define([], function () {
  var dependencies = ['TradeOffService', 'significantDigits'];
    ...
    return {
      ...
      link: function (scope) {
        ...
        function setCriterionValues() {
          if (
            scope.mostImportantCriterion.hasOwnProperty('isFavorable') &&
        ...
        function setUnfavorableValues() {
          ...
          scope.question =
            'How much worse is ' +
            scope.mostImportantCriterion.title +
            ' maximally allowed to get to justify the improvement of ' +
            scope.secondaryCriterion.title +
            '?';
        }
        ...
        function setDefaultValues() {
          ...
          scope.question =
            ...
            scope.mostImportantCriterion.title +
            ' minimally become to justify the worsening of ' +
            scope.secondaryCriterion.title +
            '?';
        }
        ...
        function createData(results) {
          return {
            xs: {line: 'line_x'},
            columns: [['line_x'].concat(results.x), ['line'].concat(results.y)],
            type: 'line'
          };
        }
      }
