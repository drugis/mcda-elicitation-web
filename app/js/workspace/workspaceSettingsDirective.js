...
define([], function() {
  ...
  var WorkspaceSettingsDirective = function(
    ...
    return {
      ...
      template: '<button class="button right" style="margin-bottom: 0;" type="button" ng-if="editMode.isUserOwner" ng-click="openSettingsModal()"><i class="fa fa-cog"></i> Settings</button>',
      link: function(scope) {
        // functions
