import DeterministicResults from 'app/ts/DeterministicTab/DeterministicResults/DeterministicResults';
import {LegendContextProviderComponent} from 'app/ts/Legend/LegendContext';
import SmaaResults from 'app/ts/SmaaTab/SmaaResults/SmaaResults';
