...
\noindent \leftpointright \, Rename 'alternative 1' to by clicking on it and entering 'lixisenatide' in the 'Title' text box. Rename 'alternative 1' to 'placebo'.
...
\noindent \leftpointright \, We will add the following Uncertainty to the ‘HbA1c/Pooled data’ data source: “The effect of lixisenatide was more pronounced in Asian patients compared to Caucasian patients. The lower effect in Caucasians is partly explained by a large placebo effect especially in some geographical regions.” To do so, click the 'Unc' text in and fill the text box.
