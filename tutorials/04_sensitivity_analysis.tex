...
\footnotetext{SMAA samples from probabilistic distributions for these values - for a more in-depth explanation of the process, see the MCDA manual and Tervonen \& Lahdelma (2007)}
\newline
