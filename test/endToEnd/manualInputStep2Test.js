...
function manualInput(browser) {
  ...
  errorService.isErrorBarHidden(browser)
    ...
    .assert.containsText('#criterion-title-1', manualInputService.CRITERION2.title)
    .assert.containsText('#criterion-description-0', manualInputService.CRITERION1.description)
    .assert.containsText('#criterion-description-1', manualInputService.CRITERION2.description)
    .assert.containsText('#linked-data-source-reference-0-0', manualInputService.DATA_SOURCE1.reference)
    .assert.containsText('#linked-data-source-reference-1-0', manualInputService.DATA_SOURCE2.reference)
...
function setStrengthAndUncertainty(browser) {
...
function cancelEditingUnit(browser) {
  manualInputService.createInputDefault(browser)
    .click('#enter-data-button')
    .click('#unit-of-measurement-0-edit')
...
function cancelEditingUncertainty(browser) {
  manualInputService.createInputDefault(browser)
    .click('#enter-data-button')
    .click('#strength-of-evidence-0-edit')
