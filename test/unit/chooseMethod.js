define(['angular', 'controllers/chooseMethod'], function(angular, ChooseMethodHandler) {
  describe("ChooseMethodHandler", function() {
	...
	expect(state.methods).toEqual({ 'ratio bound' : 'Continue with interval SWING weighting', 'exact swing' : 'Continue with exact SWING weighting', 'done' : 'Done eliciting preferences'});
      });
    });
