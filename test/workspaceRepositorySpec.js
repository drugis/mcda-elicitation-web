...
var workspaceRepository = require('../node-backend/workspaceRepository')(
  dbStub
);
var query;
...
describe('the workspace repository', function () {
  ...
  describe('setDefaultSubProblem', function () {
    const expectedQuery =
      'UPDATE workspace SET defaultSubproblemId = $1 WHERE id = $2';
  ...
  describe('getDefaultSubProblem', function () {
    const expectedQuery =
      'SELECT defaultSubproblemId FROM workspace WHERE id = $1';
  ...
  describe('setDefaultScenario', function () {
    const expectedQuery =
      'UPDATE workspace SET defaultScenarioId = $1 WHERE id = $2';
  ...
  describe('getDefaultScenarioId', function () {
    const expectedQuery =
      'SELECT defaultScenarioId FROM workspace WHERE id = $1';
    const expectedResult = 123;
    const queryResult = {
      rows: [
        {
  ...
  describe('update', function () {
    ...
    it('should update the workspace', function (done) {
      const expectedQuery =
        'UPDATE workspace SET title = $1, problem = $2 WHERE id = $3';
