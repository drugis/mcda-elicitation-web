  ...
  describe('PartialValueFunctionService', function () {
    ...
    describe('Create Linear Partial Value function', function () {
      ...
      it('determines worst values', function () {
        expect(partialValueFunctionService.worst(crit1.dataSources[0])).toEqual(
          -0.15
        );
        expect(partialValueFunctionService.worst(crit2.dataSources[0])).toEqual(
          100
        );
      });

      it('determines best values', function () {
        expect(partialValueFunctionService.best(crit1.dataSources[0])).toEqual(
          0.35
        );
        expect(partialValueFunctionService.best(crit2.dataSources[0])).toEqual(
          50
        );
      });
    });
    ...
    describe('standardizeDataSource', function () {
      it('should sort the cutoffs and values of an piecewise-linear pvf', function () {
        ...
        var result = partialValueFunctionService.standardizeDataSource(
          dataSource
        );
        var expectedResult = {
          pvf: {
    ...
    describe('getNewScenarioState', function () {
      ...
      it('should set a linear partial value function of a given direction for a criterion with an existing PVF', function () {
        ...
        const result = partialValueFunctionService.getNewScenarioState(
          scenario,
          criterion,
          direction
        );
